...
foreach ($file in $files) {
    ...
    $newContent = $content -replace "(?m)// (SharpCrafters s\.r\.o\. licenses this file to you under either an MIT license)\s*// (or a proprietary license, depending on the repository from which it was obtained.)", "// `$1 `$2"
