internal class Target
{
  ...
  static Target()
  {
    _cacheRegistration_GetResourceName1 = CachedMethodMetadata.Register((typeof(Target).GetMethod("GetResourceName1", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(int), typeof(int) }, null) ?? throw new MissingMethodException("The method 'Target.GetResourceName1(int, int, int)' could not be found using reflection.")).ThrowIfMissing("Target.GetResourceName1(int, int, int)"), new CachedMethodConfiguration() { AbsoluteExpiration = null, AutoReload = null, IgnoreThisParameter = null, Priority = null, ProfileName = (string? )null, SlidingExpiration = null }, true);
    _cacheRegistration_GetResourceName2 = CachedMethodMetadata.Register((typeof(Target).GetMethod("GetResourceName2", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string), typeof(int) }, null) ?? throw new MissingMethodException("The method 'Target.GetResourceName2(int, string, int)' could not be found using reflection.")).ThrowIfMissing("Target.GetResourceName2(int, string, int)"), new CachedMethodConfiguration() { AbsoluteExpiration = null, AutoReload = null, IgnoreThisParameter = null, Priority = null, ProfileName = (string? )null, SlidingExpiration = null }, true);
    _methodsInvalidatedBy_UpdateProtectedResourceAsync_23BEB20FE3CE3EBDD9C65F59C43F5632 = new MethodInfo[]
    {
      (typeof(Target).GetMethod("GetResourceName1", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(int), typeof(int) }, null) ?? throw new MissingMethodException("The method 'Target.GetResourceName1(int, int, int)' could not be found using reflection.")).ThrowIfMissing("Target.GetResourceName1(int, int, int)"),
      (typeof(Target).GetMethod("GetResourceName2", BindingFlags.Public | BindingFlags.Instance, null, new[] { typeof(int), typeof(string), typeof(int) }, null) ?? throw new MissingMethodException("The method 'Target.GetResourceName2(int, string, int)' could not be found using reflection.")).ThrowIfMissing("Target.GetResourceName2(int, string, int)")
    };
