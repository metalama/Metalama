...
var product = new Product( MetalamaDependencies.Metalama )
{
    ...
    PrivateArtifacts = Pattern.Create(
        // The Roslyn 5.0.0 variants of the testing packages are private, because they exist to test the
        ...
        "Metalama.Framework.Tests.UnitTestHelpers.5.0.0.$(PackageVersion).nupkg",
