        ...
        [
            ...
            new VisualStudioBuildToolsComponent(
                ...
                [
                    ...
                    // them out of the image. The .NET SDK obtains the reference assemblies of a .NET Framework
                    // target framework from the Microsoft.NETFramework.ReferenceAssemblies packages instead, which
                    // is why net462 and net481 already build although no component installs their packs. No project
                    // and no build script uses a tool of the developer packs, such as sn.exe or al.exe.
                ] ),
