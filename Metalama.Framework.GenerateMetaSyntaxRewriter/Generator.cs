...
{
    private const string _throwNotSupportedException = "throw new NotSupportedException(\"This method is generated by code in a private repository.\");";

    private readonly SyntaxDocument _syntax;
    private readonly string _targetDirectory;
    private readonly bool _generateStubs;

    private static string RemoveSuffix( string s, string suffix )
        => s.EndsWith( suffix, StringComparison.Ordinal ) ? s.Substring( 0, s.Length - suffix.Length ) : s;

    public Generator( SyntaxDocument syntax, string targetDirectory, bool generateStubs )
    {
        this._syntax = syntax;
        this._targetDirectory = targetDirectory;
        this._generateStubs = generateStubs;
    }
    ...
    private void GenerateMetaSyntaxRewriter( StreamWriter writer, SyntaxDocument[] syntaxVersions )
    {
        ...
        foreach ( var node in nodes )
        {
            ...
            if ( this._generateStubs )
            {
                writer.WriteLine( $"\t\t=> {_throwNotSupportedException}" );
            }
            else
            {
                writer.WriteLine( "\t{" );
