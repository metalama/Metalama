...
> Target line: 2027.0 (`develop/2027.0`). The 2026.1 line of the repository is the reference code base for most line numbers of the linker and the premium engine; section [0.2](00-conventions.md#02-evidence-prefixes) lists where the lines come from.
