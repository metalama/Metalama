...
- Other product solutions (`Metalama.Patterns`, `Metalama.Extensions`, `Metalama.Migration`, `Metalama.LinqPad`) each carry their own tests. The Backstage tests live in the SharpCrafters.Foundations repository.
