...
internal static class WorkspaceServices
{
    public static void Initialize()
    {
        ...
        if ( !BackstageServiceFactoryInitializer.IsInitialized )
        {
            ...
            BackstageServiceFactoryInitializer.Initialize( new BackstageInitializationOptions( new WorkspaceApplicationInfo(), MetalamaProduct.Instance ) { AddLicensing = false } );
        }
    }
}