...
namespace Metalama.Framework.Tests.AspectTests.Tests.Formatting.Output.IntroducedMemberReference;

// This test verifies that when generating HTML output, the design-time partial file
