...
using Metalama.Framework.Tests.AspectTests.Tests.Aspects.Contracts.Property_IntroducedInterface;
...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Contracts.Property_IntroducedInterface;
