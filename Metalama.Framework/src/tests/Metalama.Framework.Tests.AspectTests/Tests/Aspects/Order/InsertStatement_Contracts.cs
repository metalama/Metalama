...
using Metalama.Framework.Tests.AspectTests.Tests.Aspects.Order.InsertStatement_Contracts;
...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Order.InsertStatement_Contracts;
