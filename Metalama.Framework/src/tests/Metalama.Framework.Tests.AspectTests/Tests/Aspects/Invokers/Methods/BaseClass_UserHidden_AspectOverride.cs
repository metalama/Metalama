...
using Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Methods.BaseClass_UserHidden_AspectOverride;
using System.Linq;
...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Methods.BaseClass_UserHidden_AspectOverride;

/*
 * Tests invokers targeting a method declared in the base class which is hidden by a C# method which is then overridden by an aspect.
 */
