...
public class InvokerAspect : PropertyAspect
{
    ...
    {
        _ = target.WithObject( meta.Target.Property.DeclaringType.Fields.Single()).WithOptions( InvokerOptions.Current ).Value;
    ...
    {
        target.WithObject( meta.Target.Property.DeclaringType.Fields.Single()).WithOptions( InvokerOptions.Current ).Value = 42;
