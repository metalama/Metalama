...
using Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Properties.BaseClassVirtual_UserOverride_AspectOverride;
using System.Linq;
...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Properties.BaseClassVirtual_UserOverride_AspectOverride;

/*
 * Tests invokers targeting a virtual property declared in the base class which is overridden by a C# property which is then overridden by an aspect.
 */
