...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Properties.BaseClassVirtual_Hidden;

/*
 * Tests invokers targeting a virtual property declared in the base class which is hidden by a C# property.
 */
