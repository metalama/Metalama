...
using Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Properties.BaseClass_UserHidden_AspectOverride;
using System.Linq;
...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Properties.BaseClass_UserHidden_AspectOverride;

/*
 * Tests invokers targeting a property declared in the base class which is hidden by a C# property which is then overridden by an aspect.
 */
