...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Properties.TargetClass;

/*
 * Tests invokers targeting a property declared in the target class.
 */
