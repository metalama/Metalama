...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Properties.BaseClass;

/*
 * Tests invokers targeting a property declared in the base class.
 */
