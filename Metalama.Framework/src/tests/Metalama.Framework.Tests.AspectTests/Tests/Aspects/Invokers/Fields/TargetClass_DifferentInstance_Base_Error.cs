...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Fields.TargetClass_DifferentInstance_Base_Error;
...
public class InvokerAspect : FieldOrPropertyAspect
{
    ...
    {
        _ = target.WithObject( meta.Target.FieldOrProperty.DeclaringType.Fields.Single()).WithOptions( InvokerOptions.Base ).Value;
    ...
    {
        target.WithObject( meta.Target.FieldOrProperty.DeclaringType.Fields.Single()).WithOptions( InvokerOptions.Base ).Value = 42;
