...
using Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Events.BaseClassVirtual_AspectOverridden;
using System.Linq;
...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Events.BaseClassVirtual_AspectOverridden;

/*
 * Tests invokers targeting a virtual event declared in the base class which is overridden by an aspect-introduced event.
 */
