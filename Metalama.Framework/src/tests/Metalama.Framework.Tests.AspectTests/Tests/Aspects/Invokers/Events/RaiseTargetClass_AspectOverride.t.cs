...
{
  private static readonly global::Metalama.Framework.RunTime.ActionEventBrokerCallbacks<global::System.EventHandler, global::Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Events.RaiseTargetClass_AspectOverride.TargetClass, (global::System.Object? , global::System.EventArgs)> EventBrokerCallbacks_0 = new(static (global::System.EventHandler handler, global::Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Events.RaiseTargetClass_AspectOverride.TargetClass me, in (global::System.Object? sender, global::System.EventArgs e) args) => me.Event_Invoke_OverrideAspect(handler, args), static b => (sender, e) => b.Invoke((sender, e)), static (handler, me) => me.Event_OverrideAspect += handler, static (handler, me) => me.Event_OverrideAspect -= handler);
  private event EventHandler _event = default !;
  private volatile global::Metalama.Framework.RunTime.ActionEventBroker<global::System.EventHandler, global::Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Events.RaiseTargetClass_AspectOverride.TargetClass, (global::System.Object? , global::System.EventArgs)>? _eventBroker;
  [OverrideAspect]
