...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Events.BaseClassVirtual;

/*
 * Tests invokers targeting a virtual event that is declared in the base class.
 */
