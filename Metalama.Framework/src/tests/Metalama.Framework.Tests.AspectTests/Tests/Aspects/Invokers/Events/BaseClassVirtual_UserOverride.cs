...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Invokers.Events.BaseClassVirtual_UserOverride;

/*
 * Tests invokers targeting a virtual event declared in the base class which is overridden by a C# event.
 */
