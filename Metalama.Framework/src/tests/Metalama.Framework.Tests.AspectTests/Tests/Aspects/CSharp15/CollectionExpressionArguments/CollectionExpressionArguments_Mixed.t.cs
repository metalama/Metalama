internal class TargetType
{
  ...
  public void Method(string p)
  {
    ...
    global::System.Collections.Generic.List<global::System.String> mixedElements = [with (2), "Method", p];
    ...
    global::System.Console.WriteLine(byCapacity.Count + mixedElements.Count + named.Count + spread.Count + nested.Count);
    return;
  }
}