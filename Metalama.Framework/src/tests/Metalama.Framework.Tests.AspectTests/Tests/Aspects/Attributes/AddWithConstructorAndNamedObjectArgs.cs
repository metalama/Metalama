...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Attributes.AddWithConstructorAndNamedObjectArgs;
    ...
    public override void BuildAspect( IAspectBuilder<IMethod> builder )
    {
        ...
        builder.IntroduceAttribute(
            AttributeConstruction.Create(
                ...
                namedArguments: new KeyValuePair<string, object?>[] { new( "Name", "test" ) } ) );
    }
}
