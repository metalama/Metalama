...
using Metalama.Framework.Tests.AspectTests.Tests.Aspects.Attributes.Trivia;
...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Attributes.Trivia;
