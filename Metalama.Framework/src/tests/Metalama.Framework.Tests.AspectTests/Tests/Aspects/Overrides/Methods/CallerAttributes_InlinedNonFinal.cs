...
namespace Metalama.Framework.Tests.AspectTests.TestInputs.Aspects.Overrides.Methods.CallerAttributes_InlinedNonFinal
{
    /*
     * Tests that overriding method correctly transforms caller attribute method invocations when the source is inlined into non-final semantic.
     */
