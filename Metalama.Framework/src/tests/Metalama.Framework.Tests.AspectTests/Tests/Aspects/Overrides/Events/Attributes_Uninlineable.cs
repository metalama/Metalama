...
using System;
using Metalama.Framework.Tests.AspectTests.TestInputs.Aspects.Overrides.Events.Attributes_Uninlineable;
...
namespace Metalama.Framework.Tests.AspectTests.TestInputs.Aspects.Overrides.Events.Attributes_Uninlineable
{
    /*
