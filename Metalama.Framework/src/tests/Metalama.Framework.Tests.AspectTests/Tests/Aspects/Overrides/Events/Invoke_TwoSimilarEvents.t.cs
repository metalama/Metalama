...
{
  private static readonly global::Metalama.Framework.RunTime.Events.DelegateEventAdapter<global::System.EventHandler, (global::System.Object? , global::System.EventArgs), global::Metalama.Framework.Tests.AspectTests.Tests.Aspects.Overrides.Events.Invoke_TwoSimilarEvents.TargetClass> Event1BrokerCallbacks_0 = new(static (handler, ref args, me) => me.Event1_Invoke_Override(handler, ref args), static b => (sender, e) => b.Invoke((sender, e)), static (handler, me) => me.Event1_Override += handler, static (handler, me) => me.Event1_Override -= handler);
  private static readonly global::Metalama.Framework.RunTime.Events.DelegateEventAdapter<global::System.EventHandler, (global::System.Object? , global::System.EventArgs), global::Metalama.Framework.Tests.AspectTests.Tests.Aspects.Overrides.Events.Invoke_TwoSimilarEvents.TargetClass> Event2BrokerCallbacks_0 = new(static (handler, ref args, me) => me.Event2_Invoke_Override(handler, ref args), static b => (sender, e) => b.Invoke((sender, e)), static (handler, me) => me.Event2_Override += handler, static (handler, me) => me.Event2_Override -= handler);
