...
using System;
using Metalama.Framework.Tests.AspectTests.TestInputs.Aspects.Overrides.Events.Attributes;
...
namespace Metalama.Framework.Tests.AspectTests.TestInputs.Aspects.Overrides.Events.Attributes
{
    /*
