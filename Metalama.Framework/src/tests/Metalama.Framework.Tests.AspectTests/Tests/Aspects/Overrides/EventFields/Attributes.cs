...
using System;
using Metalama.Framework.Tests.AspectTests.TestInputs.Aspects.Overrides.EventFields.Attributes;
...
namespace Metalama.Framework.Tests.AspectTests.TestInputs.Aspects.Overrides.EventFields.Attributes
{
    /*
