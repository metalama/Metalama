...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Initialization.OnInitialized_Linker_CtorOverload;
...
public class TargetCode
{
    ...
    public TargetCode( int value, InitializationContext context )
    {
        this.Value = value;
    }
}
