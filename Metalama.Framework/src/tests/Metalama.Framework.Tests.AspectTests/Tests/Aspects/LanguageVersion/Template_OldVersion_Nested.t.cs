...
// Error CS8936 on `"""raw"""`: `Feature 'raw string literals' is not available in C# 10.0. Please use language version 11.0 or greater.`
// Error LAMA0232 on `"""raw"""`: `Template code must be written in C# 10.0.`
[TheAspect]
private void M()
{
  global::System.Console.WriteLine("""raw""" + "suffix");
  return;
}