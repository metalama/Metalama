...
/// </summary>
/// <remarks>
/// This is the Roslyn 4 counterpart of <c>UnknownAccessorInTemplate</c>. The two tests differ only in their
/// expected output: Roslyn 4.12 reports <c>CS1014</c> on an empty span, and Roslyn 5.10 reports it on the
