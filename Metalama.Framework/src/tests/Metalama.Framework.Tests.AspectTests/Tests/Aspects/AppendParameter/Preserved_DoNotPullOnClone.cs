...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.AppendParameter.Preserved_DoNotPullOnClone;

// A buggy pull strategy: always returns DoNotPull, which is invalid for an aspect-generated forwarding constructor.
