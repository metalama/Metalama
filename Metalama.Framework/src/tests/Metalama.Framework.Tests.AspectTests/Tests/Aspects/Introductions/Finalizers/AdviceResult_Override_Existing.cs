...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Introductions.Finalizers.AdviceResult_Override_Existing
{
    public class TestAspect : TypeAspect
    {
        public override void BuildAspect( IAspectBuilder<INamedType> builder )
        {
            var result = builder.IntroduceFinalizer( nameof(Finalizer), whenExists: OverrideStrategy.Override );
