...
// Error LAMA0525 on `TargetStruct`: `The aspect 'ExplicitlyVirtualIntroduction' cannot introduce virtual member 'TargetStruct.Method_ExplicitlyVirtual()' into a type 'TargetStruct' because it is a struct.`
// Error LAMA0525 on `TargetStruct`: `The aspect 'ImplicitlyVirtualIntroduction' cannot introduce virtual member 'TargetStruct.Method_ImplicitlyVirtual()' into a type 'TargetStruct' because it is a struct.`
