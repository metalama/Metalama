...
namespace Metalama.Framework.Tests.AspectTests.Tests.Aspects.Records.Equals_OverriddenProperty;

/// <summary>
/// The aspect overrides both the auto-property and the synthesized Equals, so the linker emits an explicit backing
/// field for the property. The generated Equals must read that field rather than the property, which is what the
/// compiler does.
/// </summary>
