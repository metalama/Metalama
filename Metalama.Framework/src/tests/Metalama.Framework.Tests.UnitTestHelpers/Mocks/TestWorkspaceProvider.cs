...
public sealed class TestWorkspaceProvider : WorkspaceProvider
{
    ...
    private ProjectKey GetOrAddProject( TestContext testContext, string projectName, string[]? projectReferences = null, string[]? preprocessorSymbols = null )
    {
        ...
        var parseOptions = testContext.GetCompilationParseOptions( preprocessorSymbols );
        ...
        var projectInfo = ProjectInfo.Create(
            ...
            metadataReferences: testContext.GetMetadataReferences(),
            parseOptions: parseOptions,
            compilationOptions: testContext.GetCompilationOptions() );

        projectInfo = projectInfo.WithMetadataReferences( testContext.GetMetadataReferences() );
    ...
    {
        var projectKey = this.GetOrAddProject( testContext, projectName, projectReferences, preprocessorSymbols );
    ...
    internal Document? GetDocumentOrNull( string projectName, string documentName )
    {
        var projectData = this._projectIdsByProjectName[projectName];
