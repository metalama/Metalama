<#
.SYNOPSIS
    Verifies that Metalama builds under a .NET installation outside the standard location, on Windows.
...
$arguments = @{
    ...
    Command = 'pwsh -NoProfile -NonInteractive -File Metalama.Framework/src/tests/docker/NonStandardDotNetRootWindows/Container.ps1'
}
