<#
.SYNOPSIS
    Verifies that the Metalama dotnet tool stops the processes it is meant to stop.
...
$arguments = @{
    ...
    Command = 'pwsh -NoProfile -NonInteractive -File Metalama.Framework/src/tests/docker/MetalamaKill/Container.ps1'
}
