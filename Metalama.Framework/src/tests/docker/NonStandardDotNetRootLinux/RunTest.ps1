<#
.SYNOPSIS
    Verifies that Metalama builds under a .NET installation outside the standard location, on Linux.
...
$arguments = @{
    ...
    Command = 'pwsh -NoProfile -NonInteractive -File Metalama.Framework/src/tests/docker/NonStandardDotNetRootLinux/Container.ps1'
}
