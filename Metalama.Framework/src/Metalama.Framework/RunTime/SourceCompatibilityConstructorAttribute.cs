...
/// <summary>
/// A custom attribute added by the framework to a source-compatibility constructor: a compile-time stub that
/// keeps the pre-mutation signature of a source constructor callable and chains, via <c>: this(...)</c>, to the
/// constructor that <see cref="Metalama.Framework.Advising.IAdviceFactory"/> has mutated with an appended parameter.
/// </summary>
