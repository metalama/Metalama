...
namespace Metalama.Framework.Aspects
{
    ...
    /// <see cref="Metalama.Framework.Code.Invokers.IEventInvoker.Remove(object?)">meta.Target.Event.Remove(handler)</see>.
    /// </para>
    /// <para>
    ...
    public abstract class OverrideEventAspect : EventAspect
    {
        ...
        /// <see cref="Metalama.Framework.Code.Invokers.IEventInvoker.Remove(object?)">meta.Target.Event.Remove(handler)</see>.
        /// Note that <see cref="Metalama.Framework.Code.Invokers.IEventInvoker.Raise(object?[])">meta.Target.Event.Raise()</see> is not
