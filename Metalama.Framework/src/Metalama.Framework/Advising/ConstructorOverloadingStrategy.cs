...
/// the generated forwarder with <see cref="System.ObsoleteAttribute"/>.
/// </summary>
...
public static class ConstructorOverloadingStrategy
{
    ...
    /// framework mutates. Aspect-introduced constructors are not themselves overloaded. Call
    /// <see cref="ForwardConstructorStrategy.WithObsoleteAttribute"/> on the returned instance to additionally
    /// decorate the generated forwarder with <see cref="System.ObsoleteAttribute"/>.
    /// </summary>
