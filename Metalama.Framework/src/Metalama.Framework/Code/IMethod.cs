...
namespace Metalama.Framework.Code
{
    ...
    public interface IMethod : IMethodBase, IGeneric, IMethodInvoker
    {
        ...
        /// <remarks>
        /// <para>
        /// This method generates run-time code that retrieves the <see cref="MethodInfo"/> object for the current method.
        /// While Metalama is designed to eliminate the need for reflection in most scenarios, this method is useful
        /// when you need to pass method metadata to APIs that require <see cref="MethodInfo"/> objects.
        /// </para>
        /// <para>
        /// <b>Warning:</b> The code generated by this method relies on method names and signatures, and may break if your
        /// project is obfuscated. Consider using method invokers (such as <see cref="Invokers.IMethodInvoker.Invoke(object?[])"/>)
