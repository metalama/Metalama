...
namespace Metalama.Framework.Code
{
    ...
    public interface IType : ICompilationElement, IDisplayable, IEquatable<IType>
    {
        ...
        /// </summary>
        /// <returns>A compile-time serializable reference to the current type.</returns>
        /// <remarks>
        /// <para>
        /// References are essential in Metalama because <see cref="IType"/> objects are bound to a specific
        /// <see cref="ICompilation"/>. As aspects execute, the compilation evolves through multiple immutable versions.
        /// References provide a stable way to track the same type across these versions.
        /// </para>
        /// <para>
        /// To resolve a reference back to the type, use <see cref="RefExtensions.GetTarget{T}(IRef{T})"/> or
        ...
        /// <summary>
        /// Gets the <see cref="SpecialType"/> enumeration value for the current type. Provides a fast way to determine whether
        ...
        /// <remarks>
        /// <para>
        /// This method generates run-time code that retrieves the <see cref="Type"/> object for the current type.
        /// While Metalama is designed to eliminate the need for reflection in most scenarios, this method is useful
        /// when you need to pass type information to APIs that require <see cref="Type"/> objects.
        /// </para>
        /// <para>
        /// <b>Warning:</b> The code generated by this method relies on type names and may break if your project
        /// is obfuscated. Consider using direct type references when possible to avoid obfuscation issues.
        /// </para>
        /// </remarks>
        ...
        /// <summary>
        /// Gets a value indicating whether the type is a reference type. If the type is a type parameter
