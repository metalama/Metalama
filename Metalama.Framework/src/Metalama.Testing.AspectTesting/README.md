...
The `Metalama.Testing.AspectTesting` is a test framework that you can use to test aspects and fabrics and that integrates with all test runners supporting xUnit.
...
* Documentation: [Testing the aspect's code generation and error reporting](https://doc.metalama.net/conceptual/aspects/testing/aspect-testing).
