...
#pragma warning disable SA1101
        ...
        public override PullConstructorParameterTransitiveAspect CreateInstance( IArgumentsReader constructorArguments )
        {
            ...
            // identifier. ToDurable is called nevertheless, because the field is typed IDurableRef and the serializer
            // does not promise the static type.
            var parameter = constructorArguments.GetValue<IRef<IParameter>>( nameof(_parameter) ).AssertNotNull().ToDurable();
