...
internal sealed class ConstructorInliner : Inliner
{
    ...
    public override bool IsValidForTargetSymbol( ISymbol symbol )
        => symbol.Kind == SymbolKind.Method && symbol is IMethodSymbol { MethodKind: MethodKind.Constructor };
    ...
    public override bool CanInline( ResolvedAspectReference aspectReference, SemanticModel semanticModel )
    {
        ...
        if ( aspectReference.ResolvedSemantic.Symbol.Kind != SymbolKind.Method
             || aspectReference.ResolvedSemantic.Symbol is not IMethodSymbol { MethodKind: MethodKind.Constructor } )
        {
