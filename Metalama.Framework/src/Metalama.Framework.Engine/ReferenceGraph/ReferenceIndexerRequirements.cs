    ...
    string? ValidatedIdentifier )
{
        ...
        bool includeDerivedTypes )
    {
        ...
        if ( referenceKinds.IsDefined( ReferenceKinds.BaseType )
             && validatedDeclaration.DeclarationKind is DeclarationKind.NamedType or DeclarationKind.ExtensionBlock
             && validatedDeclaration is INamedType { IsSealed: true } )
        {
