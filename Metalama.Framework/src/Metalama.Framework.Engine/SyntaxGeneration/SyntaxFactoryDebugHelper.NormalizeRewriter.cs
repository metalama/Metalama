            ...
            if ( !node.AncestorsAndSelf()
                    .Any(
                        a =>
                            ...
                            (a.Parent.IsKind( SyntaxKind.NamespaceDeclaration ) && a.Parent is NamespaceDeclarationSyntax namespaceDeclaration
                                                                                && namespaceDeclaration.Name == a) ||
                            (a.Parent.IsKind( SyntaxKind.FileScopedNamespaceDeclaration )
                             && a.Parent is FileScopedNamespaceDeclarationSyntax fileScopeNamespaceDeclaration && fileScopeNamespaceDeclaration.Name == a) ||
                            (a.Parent.IsKind( SyntaxKind.MethodDeclaration ) && a.Parent is MethodDeclarationSyntax methodDeclaration
                                                                             && methodDeclaration.ReturnType == a) ||
                            ...
                            (a.Parent.IsKind( SyntaxKind.ObjectCreationExpression ) && a.Parent is ObjectCreationExpressionSyntax objectCreation
                                                                                    && objectCreation.Type == a) ||
                            (a.Parent.IsKind( SyntaxKind.DefaultExpression ) && a.Parent is DefaultExpressionSyntax defaultExpression
                                                                             && defaultExpression.Type == a) ||
                            (a.Parent.IsKind( SyntaxKind.CastExpression ) && a.Parent is CastExpressionSyntax castExpression && castExpression.Type == a) ||
                            (a.Parent.IsKind( SyntaxKind.ExplicitInterfaceSpecifier ) && a.Parent is ExplicitInterfaceSpecifierSyntax explicitInterfaceSpecifier
                                                                                      && explicitInterfaceSpecifier.Name == a) ||
