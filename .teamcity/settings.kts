...
+:%system.teamcity.build.tempDir%/Metalama/ExtractExceptions/**/*=>logs"""
    ...
    steps {
        powerShell {
            name = "Prepare Docker image metalama-2025.2"
            id = "PrepareImage"
            scriptMode = file {
                path = "DockerBuild.ps1"
            }
            noProfile = false
            scriptArgs = "-BuildImage -ImageName metalama-2025.2"
        }
        powerShell {
            name = "Build"
            id = "Build"
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalama-2025.2 -NoBuildImage test --configuration Debug --buildNumber %build.number% --buildType %system.teamcity.buildType.id% %Build.Arguments% --timeout %Build.Timeout%"
        }
    }
    ...
    commitStatusPublisher {
        vcsRootExtId = "Metalama_Metalama20252_Metalama"
        publisher = github {
...
"""
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalama-2025.2 -NoBuildImage test --configuration Release --buildNumber %build.number% --buildType %system.teamcity.buildType.id% %Build.Arguments% --timeout %Build.Timeout%"
        }
    }
...
"""
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalama-2025.2 -NoBuildImage test --configuration Public --buildNumber %build.number% --buildType %system.teamcity.buildType.id% %Build.Arguments% --timeout %Build.Timeout%"
        }
    }
...
object PublicDeployment : BuildType({
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalama-2025.2 -NoBuildImage publish --configuration Public %Publish.Arguments% --timeout %Publish.Timeout%"
        }
    }
...
object DownstreamMerge : BuildType({
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalama-2025.2 -NoBuildImage tools git merge-downstream %DownstreamMerge.Arguments% --timeout %DownstreamMerge.Timeout%"
        }
    }
