...
object DebugBuild : BuildType({
    ...
    params {
        ...
        text("TimeOut", "1500", label = "Time-Out Threshold", description = "Seconds after the duration of the last successful build.", regex = """\d+""", validationMessage = "The timeout has to be an integer number.")
    }

    vcs {
        root(AbsoluteId("Metalama_Metalama20250_MetalamaLinqPad"))
    }
...
object PublicDeployment : BuildType({
    ...
    dependencies {
        ...
        dependency(AbsoluteId("Metalama_Metalama20250_Metalama_PublicDeployment")) {
            snapshot {
                     onDependencyFailure = FailureAction.FAIL_TO_START
            }
        }
